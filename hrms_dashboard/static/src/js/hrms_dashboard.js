...
// EVENT METHODS
    ...
    hr_new_employee(){
        this.action.doAction({
            name: _t("New Employee"),
            type: 'ir.actions.act_window',
            res_model: 'hr.employee',
            view_mode: 'tree,form,calendar',
            views: [[false, 'list'],[false, 'form']],
            domain: [['employee_id','=', this.state.login_employee.id],['state','=','draft']],
            target: 'current' //self on some of them
        });
    }
    hr_employee_resign(){
        this.action.doAction({
            ...
            view_mode: 'tree,form,calendar',
            views: [[false, 'list'],[false, 'form']],
            domain: [['employee_id','=', this.state.login_employee.id],'|',['emp_status','=','resigned'],['emp_status1','=','resigned']],
            target: 'current' //self on some of them
        });
    }
    employee_permanent(){
         this.action.doAction({
            ...
            view_mode: 'tree,form,calendar',
            views: [[false, 'list'],[false, 'form']],
            domain: [['employee_id','=', this.state.login_employee.id],['job_status','=','permanent']],
            target: 'current' //self on some of them
        });
    }
    async hr_contract() {
