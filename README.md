...
- **Main** (Stable) Merupakan stable version dari sebuah project. Branch ini akan selalu di sinkronkan dengan production setelah
...
- **Staging** (Unstable) Merupakan branch tempat berkumpulnya semua merge dari Feature Branch. Branch ini juga merupakan tempat
  Q/A berlangsung.
